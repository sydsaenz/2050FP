...
module word_sprite 
    ...
    logic [32:0] sen_sprite_x;
    logic [32:0] sen_sprite_y;
    ...
    logic [32:0] cam_sprite_x;
    logic [32:0] cam_sprite_y;
    ...
    assign pixel_red = v_count < 200 ? sen_img_red : cam_img_red;
    assign pixel_green = v_count < 200 ? sen_img_green : cam_img_green;
    assign pixel_blue = v_count < 200 ? sen_img_blue : cam_img_blue;
